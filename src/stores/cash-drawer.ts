...
export const cashInTill: Array<[string, (Writable<number> | number)]> = [ // Array for keeping track of the till state. // : Array<[string,(number | Writable<number>)]> | []
    ['PENNY', tillPennies],
    ['NICKEL', tillNickles],
    ['DIME', tillDimes],
...
export let changePile: Array<[string, (Writable<number> | number)]> | []; // Array representing change given to customer
